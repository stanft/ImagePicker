...
open class ImageGalleryView: UIView {
    ...
    struct Dimensions {
        ...
        static let galleryBarHeight: CGFloat = 10
    }
    ...
    func configure() {
        ...
        [collectionView, topSeparator].forEach {
            addSubview($0)
        }
...
extension ImageGalleryView: UICollectionViewDelegateFlowLayout {
    ...
    public func collectionView(_ collectionView: UICollectionView,
        ...
        guard let collectionSize = collectionSize else {
            return CGSize.zero
        }
...
extension ImageGalleryView: UICollectionViewDelegate {
    ...
    public func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if configuration.allowMultiplePhotoSelection == false {
            ...
            guard let visibleCells = collectionView.visibleCells as? [ImageGalleryViewCell] else {
                return
            }
