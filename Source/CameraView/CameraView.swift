...
class CameraView: UIViewController, CLLocationManagerDelegate, CameraManDelegate {
    ...
    func updateCameraOrientation() {
        print("Device orientation: \(UIDevice.currentDevice().orientation.rawValue)")
    ...
    override func viewDidLayoutSubviews() {
        ...
        if let connection = previewLayer?.connection {
            ...
            if connection.supportsVideoOrientation {
                ...
                case .Portrait:
                    updatePreviewLayer(.Portrait)
                case .PortraitUpsideDown:
                    updatePreviewLayer(.PortraitUpsideDown)
                case .LandscapeLeft:
                    updatePreviewLayer(.LandscapeRight)
                case .LandscapeRight:
                    updatePreviewLayer(.LandscapeLeft)
                default:
                    break
                }
            }
